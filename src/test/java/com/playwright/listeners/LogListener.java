...
public class LogListener implements ITestListener{
	...
	public void onTestSuccess(ITestResult result) {
		...
		System.out.println(getTestName(result) + " : Test Passed");
	}
	...
	public void onTestFailure(ITestResult result) {
		...
		System.out.println(getTestName(result) + " : Test Failed : " + cause);
	}

	@Override
	public void onTestSkipped(ITestResult result) {
		//LoggerUtil.log(getTestName(result) + " : Test Skipped");
		System.out.println(getTestName(result) + " : Test Skipped");
	}
